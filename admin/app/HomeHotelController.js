adminApp.controller('HomeHotelController', ['$scope','$location', 'localStorageService','$http','FileUploader',  function($scope,$location,localStorageService, $http, FileUploader) {
    ...
    $scope.uploader = new FileUploader({
        url: 'php/index.php?action=set&name=hotel&hotel_ID='
    });
